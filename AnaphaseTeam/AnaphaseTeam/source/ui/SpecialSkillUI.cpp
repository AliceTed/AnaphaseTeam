...
void SpecialSkillUI::initialize()
{
	...
	add(SPECIALSKILL_TYPE::SPECIALLATTACK, SkillUI(TEXTURE_ID::SPECIAL_ATTACK, MYANIMATION_ID::SPECIAL_ATTACK, GScolor(1, 0, 0, 1)));
	add(SPECIALSKILL_TYPE::SUPERARMOR, SkillUI(TEXTURE_ID::SPECIAL_SUPERARMOR, MYANIMATION_ID::SPECIAL_SUPERARMOR, GScolor(0,0, 1, 1)));
	add(SPECIALSKILL_TYPE::RECOVERY, SkillUI(TEXTURE_ID::SPECIAL_RECOVERY, MYANIMATION_ID::SPECIAL_RECOVERY, GScolor(0,1,0, 1)));
}
